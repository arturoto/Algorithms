...
function BellmanForsAlgorithm(vertices, edges, source):
	...
	for v in graph:
		distance[v] = inf
		predecessor[v] = undefines // previous node in the shortest path
	...
	for each edge (u, v) with weights w in edges:
...
if __name__ == '__main__':
	...
	alg = BF()
	alg.calculateShortestPath(vertexList, edgeList, node2)
	alg.getShortestPath(node8)
